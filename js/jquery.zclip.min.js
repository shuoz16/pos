 ...
 */(function() {
	...
	var _getDOMObjectPosition = function(obj) {
		...
		while (obj) {
			var borderLeftWidth = parseInt(_getStyle(obj, "borderLeftWidth"),
					10);
	...
	var _bridge = function() {
		...
		client.htmlBridge = document
				.getElementById("global-zeroclipboard-html-bridge");
		...
		var html = '    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="global-zeroclipboard-flash-bridge" width="100%" height="100%">       <param name="movie" value="'
				...
				+ _noCache(client.options.moviePath)
				+ '"/>       <param name="allowScriptAccess" value="always" />       <param name="scale" value="exactfit">       <param name="loop" value="false" />       <param name="menu" value="false" />       <param name="quality" value="best" />       <param name="bgcolor" value="#ffffff" />       <param name="wmode" value="transparent"/>       <param name="flashvars" value="'
				+ _vars(client.options)
				+ '"/>       <embed src="'
				+ client.options.moviePath
				+ _noCache(client.options.moviePath)
		...
		client.htmlBridge.setAttribute("class",
	...
	ZeroClipboard.prototype.receiveEvent = function(eventName, args) {
		...
		case "load":
			if (args
					&& parseFloat(args.flashVersion.replace(",", ".").replace(
							/[^0-9\.]/gi, "")) < 10) {
